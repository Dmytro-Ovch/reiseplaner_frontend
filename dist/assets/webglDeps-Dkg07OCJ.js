import{a as c}from"./ProgramTemplate-CPARWaXn.js";import{E as h,e as _,o as g,b as y}from"./ProgramTemplate-CPARWaXn.js";import{R as F,s as v}from"./FramebufferObject-ySPNeOOU.js";import{cs as P}from"./index-QkvpMIk7.js";import{t as l}from"./NestedMap-BVvDppQU.js";class ${constructor(e){this._rctx=e,this._store=new l}dispose(){this._store.forAll((e=>e.dispose())),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function p(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function d(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
